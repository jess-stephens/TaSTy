...
data_folder <- "C:/Users/jstephens/Documents/South Africa/COP23/TaSTy/Data"
...
#READ IN MSD
df_msd <- si_path() %>% 
  return_latest("MER_Structured_Datasets_PSNU_IM_FY21-23_20230210_v1_1_Zimbabwe") %>% 
  read_psd() %>% 
  resolve_knownissues()
...
%>% #select columns in DP + mech_code
...
write_csv(df_msd_final, glue::glue("C:/Users/jstephens/Documents/Zim/COP23/Dataout/Zimbabwe_cop-validation-msd_v3_{today}.csv"))
